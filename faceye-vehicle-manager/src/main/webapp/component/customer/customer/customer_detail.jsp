...
<div class="block-flat">
		...
		<div classs="table-responsive">
			<table class="table table-bordered">
				<tr>
					...
					<td><c:choose>
							<c:when test="${not empty customer.headImgUrl }">
								<img src="/UploadServlet?getfile=${customer.headImgUrl}" class="img-small img-responsive img-thumbnail">
							</c:when>
							<c:otherwise>
								<img src="<c:url value="/images/default_vehicle.jpg"/>" class="img-small img-responsive img-thumbnail">
							</c:otherwise>
						</c:choose></td>
				</tr>
				<tr>
	...
	<div class="content">
		<a href="<c:url value="/customer/customer/edit/${customer.id}"/>" class="btn btn-sm btn-primary"><fmt:message key="global.edit" /></a> <a
			href="<c:url value="/customer/customer/remove/${customer.id}"/>" class="btn btn-sm btn-danger"><fmt:message key="global.remove" /></a> <a
			href="<c:url value="/customer/customer/home"/>" class="btn btn-sm btn-info"><fmt:message key="global.back" /></a>
	</div>
</div>
