...
<div class="page-head">
	<h2>
		...
		<a class="btn btn-primary" href="<c:url value="/vehicle/scanLog/input"/>"> <fmt:message
				key="vehicle.scanLog.add"></fmt:message>
		</a>
	</h2>
</div>
<div class="cl-mcont">
	...
	<div class="block-flat">
		<div class="content">
			<form action="<c:url value="/vehicle/scanLog/home"/>" method="post" role="form"
				...
				<table class="table table-bordered">
					...
					<tbody>
						<c:forEach items="${page.content}" var="scanLog">
							<tr>
							   <td><input type="checkbox" name="check-single" value="${scanLog.id}"></td>
								<!--@generate-entity-jsp-property-value@-->
								<td><a href="<c:url value="/vehicle/scanLog/edit/${scanLog.id}"/>">
										<fmt:message key="global.edit"></fmt:message>
								</a></td>
								<td><a href="<c:url value="/vehicle/scanLog/remove/${scanLog.id}"/>">
