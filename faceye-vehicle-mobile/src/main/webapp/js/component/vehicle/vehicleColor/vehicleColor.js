/**
*说明:车辆->vehicle -> 电动车颜色 VehicleColor  js 脚本
*作者:haipenge
*/
var VehicleColor={
  init:function(){
  ...
  multiRemove:function(){
	  ...
	  if(checkedIds!=''){
		  $.ajax({
			  url:'/vehicle/vehicleColor/multiRemove',
			  type:'post',
			  dataType:'json',
			  data:{
				  ids:checkedIds
    ...
    */
    recordRemove:function(id){
       $.ajax({
			  url:'/vehicle/vehicleColor/remove/'+id,
			  type:'post',
			  dataType:'json',
			  success:function(data,textStatux,xhr){
