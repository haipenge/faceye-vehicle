...
<div class="block-flat">
	...
	<div class="content">
	  <a href="<c:url value="/vehicle/licensePlate/edit/${licensePlate.id}"/>" class="btn btn-sm btn-primary"><fmt:message key="global.edit"/></a>
	  <a href="<c:url value="/vehicle/licensePlate/remove/${licensePlate.id}"/>" class="btn btn-sm btn-danger"><fmt:message key="global.remove"/></a>
	  <a href="<c:url value="/vehicle/licensePlate/home"/>" class="btn btn-sm btn-info"><fmt:message key="global.back"/></a>
	</div>
</div>
